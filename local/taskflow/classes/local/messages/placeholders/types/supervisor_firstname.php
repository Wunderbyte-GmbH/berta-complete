 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class supervisor_firstname implements placeholders_interface {
    ...
    public function __construct($ruleid, $userid, $assignment) {
        ...
        $this->user = \core_user::get_user($assigneeprofile->supervisor ?? 0);
    ...
    public function render(&$message) {
        $placeholdertarget = "<supervisor_firstname>";
